...
REM --- Create Log File ---
ECHO "Starting Integration Test Suite for FME 2025 Workspaces Comparing with ETALON_DATA" > "%LOG_FILE%"
SET "LOG_FILE=%LOG_DIR%\fme-2025_integration_summary_%timestamp%.log"
...
ECHO.
ECHO ============================================
ECHO "Starting Integration Test Suite for FME 2026 Workspaces Comparing with ETALON_DATA" > "%LOG_FILE%"
